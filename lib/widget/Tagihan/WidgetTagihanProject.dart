...
class WidgetTagihanProject extends StatefulWidget {
  final String param;

  WidgetTagihanProject({Key key, this.param}) : super(key: key);

  @override
  _WidgetTagihanProjectState createState() => _WidgetTagihanProjectState();
}

class _WidgetTagihanProjectState extends State<WidgetTagihanProject> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        key: _scaffoldKey,
        appBar: appBar,
        body: blocOrder.listProjectDetail.isEmpty
            ? Center(
                          ...
                          Container(
                            child: StreamBuilder(
                              ...
                              builder: (BuildContext context, AsyncSnapshot<int> snapshot) {
                                bool expired = false;
                                int estimateTs = DateTime.parse(blocOrder.listProjectDetail[0].batasBayar).millisecondsSinceEpoch; // set needed date
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  ...
                                                  style: TextStyle(letterSpacing: 0.5, height: 1.5, fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white),
                                                ),
                                                SizedBox(
                                                  height: 5,
                                                ),
                                                Text(
                                                  ...
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(letterSpacing: 0.5, height: 1.5, fontSize: 12, fontStyle: FontStyle.italic, color: Colors.white),
                                                )
                                              ],
                                            ),
                                          ),
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    Money.fromInt((int.parse(blocOrder.listProjectDetail[0].biayaSurvey)), IDR).toString(),
                                                  ...
                                                  GestureDetector(
                                                    ...
                                                    onTap: () {
                                                      Clipboard.setData(new ClipboardData(text: blocOrder.listProjectDetail[0].biayaSurvey));
                                                      _scaffoldKey.currentState.showSnackBar(new SnackBar(
                                                        content: Text('Salin ' + "'" + blocOrder.listProjectDetail[0].biayaSurvey + "'"),
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Text(
                                                                'INV: ' + blocOrder.listProjectDetail[0].noOrder,
...
//                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                  children: <Widget>[
                                                                    ...
                                                                    InkWell(
                                                                        onTap: () async {
                                                                          var url =
                                                                              'https://app.midtrans.com/snap/v1/transactions/' + blocOrder.listProjectDetail[0].tokenVa + '/pdf';
                                                                          Navigator.push(
                                                                              context,
                                                                              SlideRightRoute(
