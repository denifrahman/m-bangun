...
class WidgetKontrak extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(blocProject.listProjectDetail[0].userTtd);
              ...
              blocProject.listBids.where((element) => element.status == '1').length == 0
                ...
                child: ListTile(
                  title: SizedBox(
                    ...
                    child: blocProject.listProjectDetail[0].userTtd == null || blocProject.listProjectDetail[0].userTtd == ''
                        ? RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        : Container(
                      child: Center(child: Text('Kontrak sudah di tanda tangani')),
                    ),
                  ),
                  leading: InkWell(
                    onTap: () {
