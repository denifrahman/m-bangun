...
class _WidgetPendaftaranState extends State<WidgetPendaftaran> {
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            new Expanded(
                              child: TextFormField(
                                initialValue:
                                    blocAuth.currentUserLogin['nama'] == null
                                        ? ''
                                        : blocAuth.currentUserLogin['nama'],
                                onSaved: (value) {
                                  setState(() {
                                    nama = value;
                                  });
                              ...
                              child: TextFormField(
                                initialValue:
                                    blocAuth.currentUserLogin['email'] == null
                                        ? ''
                                        : blocAuth.currentUserLogin['email'],
                                onSaved: (value) {
                                  setState(() {
                                    email = value;
                                  });
                          ...
                          children: <Widget>[
                            ...
                            new Expanded(
                              child: TextFormField(
                                enabled: false,
                                initialValue:
                                    blocAuth.currentUserLogin['no_hp'] == null
                                        ? ''
                                        : blocAuth.currentUserLogin['no_hp'],
                                onSaved: (value) {
                                  setState(() {
                                    no_hp = value;
                                  });
                        ...
                        child: Column(
                          children: <Widget>[
                            GenderSelection(
                              ...
                              selectedGender: blocAuth
                                          .currentUserLogin['jenis_kelamin'] ==
                                      null
                                  ? null
                                  : blocAuth.currentUserLogin['jenis_kelamin']
                                              .toString() ==
                                          'L'
                                      ? Gender.Male
                                      : Gender.Female,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            new Expanded(
                              child: TextFormField(
                                initialValue: blocAuth
                                            .currentUserLogin['tempat_lahir'] ==
                                        null
                                    ? ''
                                    : blocAuth.currentUserLogin['tempat_lahir'],
                                onSaved: (value) {
                                  setState(() {
                                    tempat_lahir = value;
                                  });
  ...
  _simpan() async {
    ...
    map['jenis_kelamin'] =
        jenis_kelamin ?? blocAuth.currentUserLogin['jenis_kelamin'];
    if (_formKey.currentState.validate()) {
      if (jenis_kelamin != null ||
          blocAuth.currentUserLogin['jenis_kelamin'] != null) {
    ...
    var userUpdate =
        await FirebaseFirestore.instance.collection('users').doc('no_hp').get();
    userUpdate.reference.update({'name': nama.toString()});
  }
