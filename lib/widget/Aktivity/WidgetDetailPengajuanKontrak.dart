...
import 'package:apps/widget/Aktivity/component/WidgetDeskripsiPengajuan.dart';
import 'package:apps/widget/Aktivity/component/WidgetDetailBahanPengajuan.dart';
import 'package:apps/widget/Aktivity/component/WidgetDetailLokasiPengajuan.dart';
import 'package:apps/widget/Aktivity/component/WidgetKontrak.dart';
                        ...
                        child: Column(
                          children: <Widget>[
                            Padding(
                              ...
                              child: WidgetDeskripsiPengajuan(),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 10),
                              child: WidgetDetailLokasiPengajuan(dataProvider: dataProvider),
                            ),
                            param != 'Publish'
                                ? Padding(
                                    padding: const EdgeInsets.symmetric(horizontal: 10),
                                    child: WidgetDetailBahanPengajuan(),
                                  )
                                : Container(),
